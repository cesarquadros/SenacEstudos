...
public class FrmAgendamento {
	...
	private JTextField txtFuncionar;
	...
	private void initialize() throws ParseException {
		...
		formPrincipal.setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{txtCliente, txtFuncionar,  btnSalvar, btnCancelar, bntEditar}));
		...
		txtFuncionar = new JTextField();
		txtFuncionar.setColumns(10);
		txtFuncionar.setBounds(143, 160, 108, 20);
		formPrincipal.getContentPane().add(txtFuncionar);
